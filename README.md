      ...
      Gambar
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
				...
				<img class="d-block w-100" src="MAMPANG 1.png" alt="First slide">
            </div>
                      </div>
          <a class="carousel-control-prev" href="MAMPANG 2.png" role="button" data-slide="prev">
            <span class="carousel-control-custom-icon" aria-hidden="true">
              <i class="fas fa-chevron-left"></i>
            </span>
            <span class="sr-only">Previous</span>
          </a>
          <a class="carousel-control-next" href="MAMPANG 3.png" role="button" data-slide="next">
            <span class="carousel-control-custom-icon" aria-hidden="true">
        ...
        <table class="table table-bordered">
          <thead>
			 <tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td>Ruko Jalan Mampang Prapatan Raya No.76B RT.009 RW.03			
Kelurahan Tegal Parang, Kecamatan Mampang Prapatan			
Kota Jakarta Selatan, Provinsi DKI Jakarta.</tr>
			 <tr>
              <td>Basis Nilai</td>
              <td>: </td>
			...
			<tr>
              ...
              <td>:</td>
              <td><a href="https://www.google.com/maps/place/6%C2%B014'53.1%22S+106%C2%B049'33.9%22E/@-6.2480787,106.8234971,17z/data=!3m1!4b1!4m4!3m3!8m2!3d-6.248084!4d106.826072?entry=ttu">
          -6.248084, 106.826072   											
                  </a></td>
            </tr>
			<tr>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
			<tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td> Jl. Mampang Prapatan Raya </td>
            </tr>
			<tr>
              <td>Titik Koordinat</td>
              <td>:</td>
              <td><a href="https://www.google.com/maps/place/6%C2%B014'34.7%22S+106%C2%B049'31.6%22E/@-6.2429587,106.8228751,17z/data=!3m1!4b1!4m4!3m3!8m2!3d-6.242964!4d106.82545?entry=ttu">
           -6.242964, 106.825450 	 	 									
                  </a></td>
            </tr>
			<tr>
        ...
        <table class="table table-bordered">
          <tbody>
			<tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td> Jl. Mampang Prapatan Raya (depan halte Trans Jakarta) </td>
            </tr>
			<tr>
              <td>Titik Koordinat</td>
              <td>:</td>
              <td><a href="https://www.google.com/maps/place/6%C2%B014'32.4%22S+106%C2%B049'31.5%22E/@-6.2423297,106.8228321,17z/data=!3m1!4b1!4m4!3m3!8m2!3d-6.242335!4d106.825407?entry=ttu">
          -6.242335, 106.825407 						 										
                  </a></td>
            </tr>
			<tr>
        ...
        <table class="table table-bordered">
         <tbody>
			<tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td> Jl. Mampang Prapatan Raya (samping Domino Pizza) </td>
            </tr>
			<tr>
              <td>Titik Koordinat</td>
              <td>:</td>
              <td><a href="https://www.google.com/maps/place/6%C2%B014'26.3%22S+106%C2%B049'33.5%22E/@-6.2406427,106.8233841,17z/data=!3m1!4b1!4m4!3m3!8m2!3d-6.240648!4d106.825959?entry=ttu">
       -6.240648, 106.825959 							
                  </a></td>
            </tr>
			<tr>
